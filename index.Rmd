...
background-image: url(./imagenes/fondoslides.png)
...
knitr::include_graphics("imagenes/imagen1.jpg")
```
...
```{r echo=FALSE, out.width = "100px", out.height="50px",fig.align='center'}
knitr::include_graphics("imagenes/i.acumulada14.png")
```
...
```{r echo=FALSE, out.width = "100px", out.height="50px",fig.align='center'}
knitr::include_graphics("imagenes/formula_tasa_fallecidos_covid.png")
``` 
...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, comment= FALSE,out.width = '700px',out.height= '350px',fig.align='center'}
...
---
##Fallecidos por género y grupo de edad

```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, comment= FALSE, include= FALSE,out.width = '700px',out.height= '350px',fig.align='center'}
...
knitr::include_graphics("imagenes/semaforo_covid1.jpg")
```
---
...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, comment= FALSE,,out.width = '650px',out.height= '400px',fig.align='center'}
...
[Villahermosa del Río tiene la mayor tasa de mortalidad por la Covid-19 de toda la Comunitat Valenciana - Noticia El Periódico de Aquí](https://www.elperiodicodeaqui.com/epda-noticias/villahermosa-del-r-o-tiene-la-mayor-tasa-de-mortalidad-por-la-covid-19-de-toda-la-comunitat-valenciana/232396)
---
...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, comment= FALSE,,out.width = '600px',out.height= '30px',fig.align='center'}
...
```{r echo=FALSE, out.width = "500px", out.height="250px",fig.align='center'}
knitr::include_graphics("imagenes/familia_feliz.jpg")
```
